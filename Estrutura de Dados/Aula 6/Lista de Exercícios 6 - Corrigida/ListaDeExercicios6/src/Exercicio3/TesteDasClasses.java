/*3. A classe Aluno possui atributos que são criados na classe concreta e acessados 
 * por meio dos métodos públicos da classe (getters e setters). 
 * Dado o cenário implemente uma Lista Encadeada que 
 * utilize somente métodos recursivos em todas as implementações 
 * que envolvam estruturas de repetições. 
 */
	...
	public static void main(String[]args){
		...
		while(op!=99){
			...
			case 3:
				...
				l.AdicionarPosicao(aluno, pos, null, 0);
				break;
			case 4:
				aluno = new Aluno();
				aluno = l.RemoveFinal();
