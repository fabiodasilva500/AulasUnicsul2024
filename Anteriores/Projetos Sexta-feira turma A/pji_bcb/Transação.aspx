<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Transação.aspx.cs" Inherits="Transação" %>
...
<body>
    ...
    <div class="camadaColor">
        ...
        <div class="janela3">
            <div class="tituloPagina"><p>TRANSFERIR</p></div>
            <p>
                ...
                <asp:Label ID="vtrans" runat="server" Text=""></asp:Label>
                  <asp:Label ID="vsub" runat="server" Text=""></asp:Label>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="valor" TextMode="Number" />
                        </td>
                        <td>
                            <asp:Button Text="Concluir" runat="server" Class="botao" ID="btnconcluir" OnClick="btnconcluir_Click" />
